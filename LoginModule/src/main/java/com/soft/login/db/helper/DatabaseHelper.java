package com.soft.login.db.helper;
...
////            TableUtils.dropTable(connectionSource, CodesDto.class, true);
////            TableUtils.dropTable(connectionSource, ClassStudentsDto.class, true);
////            TableUtils.dropTable(connectionSource, SubjectsDto.class, true);
////            TableUtils.dropTable(connectionSource, EbookheaderDto.class, true);
////            TableUtils.dropTable(connectionSource, StuInfoDto.class, true);
////            TableUtils.dropTable(connectionSource, CourseDto.class, true);
////            TableUtils.dropTable(connectionSource, CurriculumPlanDto.class, true);
////            onCreate(database, connectionSource);
//
//            //在数据库版本3的时候向 PersonDao表中添加了 test字段
